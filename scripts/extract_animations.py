...
parser.add_argument("-e", "--animations", type=Path, default=default_animations_path, help="The path to the merged assets lsx.")

parser.description = "Extract animation data from a path."
new_line = "\n    "
parser.usage = f"""
Example usage:
python extract_animations.py -d "C:\lslib\divine.exe" -f "G:/Modding/BG3/_Extracted/Public/Shared/Content/Assets/_merged.lsx"
"""
