...
---@overload fun(a0:CHARACTER, a1:GUIDSTRING, a2:integer, a3:ANIMATION, a4:string)
---@param character CHARACTER
---@param target GUIDSTRING
---@param playSpawn integer
...
---@overload fun(a0:CHARACTER, a1:number, a2:number, a3:number, a4:integer, a5:ANIMATION, a6:string)
---@param character CHARACTER
---@param x number
---@param y number
---@param z number
...
---@overload fun(a0:CHARACTER, a1:GUIDSTRING, a2:GUIDSTRING, a3:integer, a4:ANIMATION, a5:string)
---@param character CHARACTER
---@param target GUIDSTRING
---@param directionFrom GUIDSTRING
---@param playSpawn integer
...
---@overload fun(a0:CHARACTER, a1:number, a2:number, a3:number, a4:GUIDSTRING, a5:integer, a6:ANIMATION, a7:string)
---@param character CHARACTER
---@param x number
---@param y number
---@param z number
...
---@overload fun(a0:CHARACTER, a1:CHARACTER, a2:GUIDSTRING, a3:integer, a4:ANIMATION, a5:string)
---@param character CHARACTER
---@param target CHARACTER
---@param directionFrom GUIDSTRING
---@param playSpawn integer
...
---@overload fun(a0:CHARACTER, a1:GUIDSTRING, a2:string, a3:integer, a4:string)
---@param character CHARACTER
---@param target GUIDSTRING
...
---@overload fun(a0:CHARACTER, a1:string)
---@overload fun(a0:CHARACTER, a1:string, a2:integer)
---@param character CHARACTER
---@param spell string
...
---@overload fun(a0:CHARACTER, a1:ITEM, a2:string)
---@param character CHARACTER
---@param item ITEM
---@param event string
...
---@overload fun(a0:CHARACTER, a1:GUIDSTRING, a2:string, a3:string)
---@param character CHARACTER
---@param target GUIDSTRING
---@param movementSpeed string
---@param event string
...
---@overload fun(a0:CHARACTER, a1:number, a2:number, a3:number, a4:string, a5:string)
---@param character CHARACTER
---@param x number
---@param y number
---@param z number
...
---@overload fun(a0:CHARACTER, a1:GUIDSTRING)
---@param character CHARACTER
---@param target GUIDSTRING
...
---@overload fun(a0:CHARACTER, a1:ITEM, a2:integer, a3:integer)
---@param character CHARACTER
---@param item ITEM
...
---@overload fun(a0:CHARACTER)
---@overload fun(a0:CHARACTER, a1:CHARACTER)
...
---@overload fun(a0:CHARACTER, a1:CHARACTER, a2:integer)
---@overload fun(a0:CHARACTER, a1:CHARACTER, a2:integer, a3:TRADEMODE)
---@param player CHARACTER
---@param trader CHARACTER
...
---@overload fun(a0:ITEM, a1:GUIDSTRING, a2:number, a3:number, a4:integer)
---@param item ITEM
---@param target GUIDSTRING
---@param speed number
...
---@overload fun(a0:ITEM, a1:number, a2:number, a3:number, a4:number, a5:number)
---@param item ITEM
---@param x number
---@param y number
---@param z number
...
---@overload fun(a0:ITEMROOT, a1:GUIDSTRING, a2:integer)
---@param itemTemplate ITEMROOT
---@param inventoryHolder GUIDSTRING
---@param count integer
---@param showNotification integer
...
---@overload fun(a0:ITEM, a1:number, a2:number, a3:number)
---@param item ITEM
---@param x number
---@param y number
---@param z number
...
---@overload fun(a0:GUIDSTRING, a1:GUIDSTRING)
---@overload fun(a0:GUIDSTRING, a1:GUIDSTRING, a2:integer, a3:integer, a4:integer)
...
---@overload fun(a0:ITEM, a1:GRAVITYTYPE)
---@param item ITEM
...
---@overload fun(a0:FLAG)
---@overload fun(a0:FLAG, a1:GUIDSTRING)
---@overload fun(a0:FLAG, a1:GUIDSTRING, a2:integer)
---@param flag FLAG
---@param object GUIDSTRING
...
---@overload fun(a0:CHARACTER, a1:FLAG)
---@param character CHARACTER
---@param flag FLAG
...
---@overload fun(a0:GUIDSTRING, a1:number, a2:number, a3:number)
---@overload fun(a0:GUIDSTRING, a1:number, a2:number, a3:number, a4:string, a5:integer)
---@overload fun(a0:GUIDSTRING, a1:number, a2:number, a3:number, a4:string, a5:integer, a6:integer, a7:integer)
...
---@overload fun(a0:GUIDSTRING, a1:GUIDSTRING)
---@overload fun(a0:GUIDSTRING, a1:GUIDSTRING, a2:string)
---@overload fun(a0:GUIDSTRING, a1:GUIDSTRING, a2:string, a3:integer)
---@overload fun(a0:GUIDSTRING, a1:GUIDSTRING, a2:string, a3:integer, a4:integer)
---@overload fun(a0:GUIDSTRING, a1:GUIDSTRING, a2:string, a3:integer, a4:integer, a5:integer)
---@param sourceObject GUIDSTRING
...
---@overload fun(a0:GUIDSTRING, a1:string)
---@param object GUIDSTRING
---@param event string
...
---@overload fun(a0:GUIDSTRING, a1:string, a2:number)
---@param object GUIDSTRING
---@param event string
...
---@overload fun(a0:GUIDSTRING, a1:GUIDSTRING, a2:string, a3:number)
---@param object1 GUIDSTRING
---@param object2 GUIDSTRING
---@param event string
---@param realParam number
...
---@overload fun(a0:GUIDSTRING, a1:string, a2:DIALOGRESOURCE)
---@param object GUIDSTRING
---@param event string
---@param dialog DIALOGRESOURCE
---@param unicast integer
...
---@overload fun(a0:GUIDSTRING, a1:GUIDSTRING, a2:string, a3:DIALOGRESOURCE)
---@param object1 GUIDSTRING
---@param object2 GUIDSTRING
---@param event string
---@param dialog DIALOGRESOURCE
...
---@overload fun(a0:GUIDSTRING, a1:string, a2:GUIDSTRING)
---@param object GUIDSTRING
---@param event string
...
---@overload fun(a0:ITEM, a1:GUIDSTRING)
---@overload fun(a0:ITEM, a1:GUIDSTRING, a2:integer)
---@overload fun(a0:ITEM, a1:GUIDSTRING, a2:integer, a3:integer)
---@param object GUIDSTRING
---@param targetObject GUIDSTRING
---@param amount integer
---@param showNotification integer
...
---@overload fun(a0:GUIDSTRING, a1:EFFECTRESOURCE)
---@overload fun(a0:GUIDSTRING, a1:EFFECTRESOURCE, a2:string)
---@param object GUIDSTRING
---@param fxName EFFECTRESOURCE
---@param bone string
---@param scale number
...
---@overload fun(a0:EFFECTRESOURCE, a1:number, a2:number, a3:number)
---@param fxName EFFECTRESOURCE
---@param x number
---@param y number
---@param z number
...
---@overload fun(a0:GUIDSTRING, a1:string, a2:integer)
---@param entity GUIDSTRING
---@param timer string
---@param time2 integer
---@param shouldTickOnTurnStart integer
...
---@overload fun(a0:string, a1:string)
---@param character CHARACTER
---@param questID string
---@param stateID string
...
---@overload fun(a0:CHARACTER, a1:number, a2:string)
---@param character CHARACTER
---@param seconds number
---@param fadeID string
...
---@overload fun(a0:GUIDSTRING, a1:string, a2:number, a3:number)
---@param target GUIDSTRING
---@param surfaceType string
---@param radius number
---@param lifetime number
...
---@overload fun(a0:number, a1:number, a2:number, a3:string, a4:number, a5:number)
---@param x number
---@param y number
---@param z number
---@param surfaceType string
...
---@overload fun(a0:number, a1:number, a2:number, a3:string, a4:integer)
---@param x number
---@param y number
---@param z number
---@param spellID string
...
---@overload fun(a0:GUIDSTRING, a1:ANIMATION)
---@param sourceObject GUIDSTRING
...
---@overload fun(a0:GUIDSTRING, a1:string, a2:number)
---@overload fun(a0:GUIDSTRING, a1:string, a2:number, a3:integer)
---@param object GUIDSTRING
---@param status string
---@param duration number
---@param force integer
...
---@overload fun(a0:ITEM)
---@overload fun(a0:GUIDSTRING, a1:DEATHTYPE, a2:integer)
---@overload fun(a0:GUIDSTRING, a1:DEATHTYPE, a2:GUIDSTRING, a3:integer, a4:integer)
---@param target GUIDSTRING
...
---@overload fun(a0:GUIDSTRING, a1:integer, a2:string)
---@param object GUIDSTRING
...
---@overload fun(a0:CHARACTER, a1:GUIDSTRING, a2:string, a3:DIFFICULTYCLASS, a4:string)
